...
import curri from './imagenes/curri.jpg'
import fotito from './imagenes/fotito.jpg'
import utd from './imagenes/utd.png'
import mockup from './imagenes/mockup.png'
...
function App() {
  ...
  <br></br><br></br><br></br>
              ...
              <Button variant="dark" href="https://github.com/abt2207/lopez_jueves_9.git">GITHUB</Button>
            </center>
          </Route>

          <Route path="/alumno">
            <center> <h1 class="name">Alberto Romero 5 A </h1></center>
          </Route>
          ...
          <Route path="/universidad">
            <center><h1 class="uni">UNIVERSIDAD TECNOLOGICA DE DURANGO</h1></center>
          </Route>
